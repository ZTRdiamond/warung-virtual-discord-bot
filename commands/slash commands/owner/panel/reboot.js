module.exports = [{
    ...
    prototype: "button",
    code: `
$interactionReply[;{newEmbed:{color:$getVar[color]}{description:❔︱Are you sure to reboot the bot?}};{actionRow:{button:Yes:3:yes-reboot:no}{button:No:4:no-reboot:no}};;all;true]
...
`
    ...
    code: `
$reboot[index.js]
$interactionUpdate[;{newEmbed:{color:$getVar[color]}{description:✅︱Success reboot the bot system!}};;;all;true]
...
`
    ...
    prototype: "button",
    code: `
$interactionUpdate[;{newEmbed:{color:$getVar[color]}{description:❎︱You cancel not to reboot the bot!}};;;all;true]
