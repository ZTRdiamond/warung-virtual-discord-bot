module.exports = [{
    ...
    prototype: "button",
    code: `
$interactionReply[;{newEmbed:{color:$getVar[color]}{description:❔︱Are you sure to reload all commands?}};{actionRow:{button:Yes:3:yes-reload:no}{button:No:4:no-reload:no}};;all;true]
...
$updateCommands
$interactionUpdate[;{newEmbed:{color:$getVar[color]}{description:✅︱Success reload all commands!}};;;all;true]
...
`
    ...
    prototype: "button",
    code: `
$interactionUpdate[;{newEmbed:{color:$getVar[color]}{description:❎︱You cancel not to reload commands!}};;;all;true]
